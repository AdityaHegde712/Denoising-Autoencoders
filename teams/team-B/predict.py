...
def main():
    ...
    parser.add_argument("--ckpt", type=str, required=False, help="Path to checkpoint .pt", default="./runs/krishna_add_skip/best.pt")
    ...
    args.outdir = os.path.join(os.path.dirname(args.ckpt), "predict_outputs")
    ...
    for img_path in tqdm(image_paths, desc="Inference"):
        ...
        y = x - y  # Denoising autoencoder: output = input - noise
        y = y.clamp(0, 1)
